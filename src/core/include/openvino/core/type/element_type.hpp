...
enum class Type_t {
    ...
    bf8,        //!< f8 1s5e2m element type
    hf8         //!< f8 1s4e3m element type
};
...
/// \brief bf8 element type
/// \ingroup ov_element_cpp_api
constexpr Type bf8(Type_t::bf8);
/// \brief hf8 element type
/// \ingroup ov_element_cpp_api
constexpr Type hf8(Type_t::hf8);
