...
class SmoothQuantize(Algorithm):
    ...
    def run(self, model):
        ...
        for node_name, stats_list in activations_statistics.items():
            ...
            stats[node_name]['channel_range_mean_max'] = stats_list[
                'channel_range_max']  # np.max(stats_list['channel_range_max'], axis=0)
    ...
    def get_activations_statistics_layout(self, model):
        ...
        for node_pair_data in node_pairs_list:
            ...
            stats_layout[name] = {'channel_range_mean': TensorStatistic(asf.mean_per_channel_transformer),
