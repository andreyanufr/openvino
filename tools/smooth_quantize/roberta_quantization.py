...
calibration_dataset = load_dataset('mteb/stsbenchmark-sts', split='train[:1000]')
...
ir_model_xml = "/home/aanuf/int8__/transformer_experiments/model/roberta-base/onnx/onnx/FP16/1/dldt/roberta-base.xml"
ir_model_bin = "/home/aanuf/int8__/transformer_experiments/model/roberta-base/onnx/onnx/FP16/1/dldt/roberta-base.bin"
...
class TextPreprocessor:
    ...
    def __call__(self, data_item):
        input_ids = self._tokenizer(data_item['sentence1'])
...
tokenizer = build_tokenizer("roberta-base", model_max_length=128)

data_loader = MRPCDataLoader(calibration_dataset, TextPreprocessor(tokenizer, max_len=128))
...
compressed_model_paths = save_model(model=compressed_model, save_path=MODEL_DIR, model_name="roberta_base_sq")
compressed_model_xml = compressed_model_paths[0]["model"]
print("Save compressed model: ", compressed_model_xml)
